...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Enums
  'enum.WINTER': { cs: 'Zimní semestr', en: 'Winter Term' },
  ...
  'courseList.project_count': { cs: 'projektů', en: 'projects' },
  'courseDetail.syllabus': { cs: 'Sylabus', en: 'Syllabus' },
  'courseDetail.evaluation_criteria': { cs: 'Kritéria hodnocení', en: 'Evaluation Criteria' },
  'courseDetail.min_score': { cs: 'Minimum bodů', en: 'Min Score' },
  'courseDetail.points': { cs: 'bodů', en: 'points' },
  'courseDetail.lecturers': { cs: 'Vyučující', en: 'Lecturers' },
  'courseDetail.links': { cs: 'Odkazy', en: 'Links' },
  ...
  'courseDetail.peer_bonus': { cs: 'Peer bonus', en: 'Peer Bonus' },
  ...
  'lecturer.actions_requested': { cs: 'Vyžaduje akci', en: 'Actions requested' },
  ...
  'lecturer.edit_evaluation': { cs: 'Upravit hodnocení', en: 'Edit Evaluation' },
  'lecturer.pending_status': { cs: 'čeká se (studenti {s_curr}/{s_total}, lektoři {l_curr}/{l_total})', en: 'pending (students {s_curr}/{s_total}, lecturers {l_curr}/{l_total})' },
  'lecturer.avg_score': { cs: 'Průměrné body', en: 'Average Points' },
  'lecturer.show_results': { cs: 'Zobrazit výsledky', en: 'Show Results' },
  'lecturer.hide_results': { cs: 'Skrýt výsledky', en: 'Hide Results' },
  'lecturer.lecturer_scores': { cs: 'Hodnocení lektorů', en: 'Lecturer Evaluations' },
  'lecturer.peer_feedback': { cs: 'Studentská zpětná vazba', en: 'Peer Feedback' },
  'lecturer.criterion': { cs: 'Kritérium', en: 'Criterion' },
  'lecturer.score': { cs: 'Body', en: 'Points' },
  ...
  'student.unlock_hint': { cs: 'Výsledky se odemknou, jakmile všichni lektoři a studenti odevzdají svá hodnocení.', en: 'Results will unlock once all lecturers and students submit their evaluations.' },
  'student.evaluation_status': { cs: 'Stav hodnocení', en: 'Evaluation Status' },
  'student.submitted': { cs: 'Odevzdáno', en: 'Submitted' },
  'student.draft': { cs: 'Rozpracováno', en: 'Draft' },
  ...
  'student.locked': { cs: 'Uzamčeno', en: 'Locked' },
  ...
  'admin.search_placeholder': { cs: 'Hledat jméno nebo email...', en: 'Search name or email...' },
  ...
  'admin.confirm_relock': { cs: 'Opravdu chcete výsledky znovu uzamknout? Tímto se výsledky skryjí před studenty a lektoři budou moci znovu upravovat hodnocení.', en: 'Are you sure you want to relock results? This will hide results from students and allow lecturers to edit evaluations again.' },
  ...
  'course.lecturers': { cs: 'Lektoři', en: 'Lecturers' },
  'course.owner_email': { cs: 'Email vlastníka kurzu', en: 'Course Owner Email' },
  'course.info': { cs: 'Informace o kurzu', en: 'Course Information' },
  ...
  'course.default_criterion_code': { cs: 'Kvalita kódu', en: 'Code Quality' },
  'course.default_criterion_test': { cs: 'Testování a nasazení', en: 'Testing & Deployment' },
