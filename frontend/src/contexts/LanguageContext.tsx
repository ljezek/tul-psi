...
const translations: Record<string, Record<Language, string>> = {
  ...
  'login.code_sent': { cs: 'Kód byl odeslán na', en: 'A code was sent to' },
  ...
  'login.error_wrong_otp_remaining': { cs: 'Nesprávný kód. Zbývá {remaining} pokus(ů).', en: 'Incorrect code. {remaining} attempt(s) remaining.' },
